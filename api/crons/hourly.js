        ...
        try {
            ...
            if (mail.gathering) {
                ...
                params = {
                    ...
                    G_link: process.env.BASE_URL + '/c/' + mail.gathering.organization.slug + '/events/' + mail.gathering.id
                }
            }
        ...
        try {
            ...
            const response = await sendBulkMail(users, {
                ...
                params: {
                    ...
                    link: process.env.BASE_URL + '/c/' + gathering.organization.slug + '/events/' + gathering.id,
                    cancel: process.env.BASE_URL + '/c' + gathering.organization.slug + '/events/' + gathering.id + '?manage'
                }
            })
