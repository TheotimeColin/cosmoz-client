<template>
    <div class="page" v-if="$constellation">
        <div class="Page_wrapper Page_wrapper--feed Wrapper Wrapper--xs">
            <div class="block-cosmoz-r mb-15 mb-10@xs" v-if="$route.params.tagId == 'présentations' && $constellation.type == 'community' && !$store.getters['user/notif']('introduced', $constellation._id) && $isConsteMember">
