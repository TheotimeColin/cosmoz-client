            ...
            <template slot="content">
                <form @submit.prevent="onSubmit" class="Messages_form">
                    <div class="p-15 bg-bg-strong mb-15">
                        <input-user-select placeholder="À qui veux-tu écrire ?" v-model="formData.users" />
                    </div>
                    ...
                    <div class="ph-15 pb-15 text-right">
                        <button-base :modifiers="['cosmoz']" icon-after="paper-plane" :disabled="formData.users.length <= 0 || !formData.content" :loading="isNewLoading">
                            Envoyer
                        </button-base>
                    </div>
                </form>
