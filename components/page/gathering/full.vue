<template>
    <div>
        <popin :is-active="isActive" :modifiers="['panel']" :title="'Détails de : ' + gathering.title" query="full" @close="$emit('close')" @open="$emit('open')">
            <div class="p-30 p-20@s" slot="content">
                <transition name="fade">
                    <div v-show="!isManage">
                        ...
                        <div class="+mt-30 pv-20 fx-center bg-bg b-top" style="position: sticky; bottom: 0;" v-if="user && !hasWaitingList && !gathering.isPast">
                            <div></div>
                    ...
                    <div v-show="isManage">
                        <template v-if="hasBooked">
                            ...
                            <div class="block mt-20">
                                <p>Tu as dû recevoir un email de confirmation avec un récapitulatif des informations. Vérifie tes spam !</p>

                                <link-base class="mt-15" :href="googleCal" icon-before="calendar" target="_blank">Ajouter à Google Calendar</link-base>
                            </div>
                            ...
                            <div class="block-r bg-bg-strong mt-20">
                                ...
                                <div>
                                    <b>L'équipe de {{ constellation.name }}</b> se donne beaucoup de mal pour organiser ces sorties gratuites !
                                ...
                                <button-base class="mt-15" icon-before="times" :loading="isLoading" @click="onBookUpdate('cancelled')">
                                    Me désinscrire
                                </button-base>
                            </div>
                        </template>
                        <template v-else>
                            <div class="block">
                                ...
                                <b>L'équipe de {{ constellation.name }}</b> comptent sur ta venue le jour J ! Les membres qui ne viennent pas, sans prévenir ou se désinscrire, peuvent être exclus du groupe ou même de la plateforme.
                            </div>
                        </template>
                        ...
                        <div class="pv-20 fx-center bg-bg b-top mt-20 fx-reverse@xs" style="position: sticky; bottom: 0;">
                            ...
                            <button-base :modifiers="['light']" :loading="isLoading" @click="onBookUpdate('attending')" icon-before="check" v-if="!hasBooked">
